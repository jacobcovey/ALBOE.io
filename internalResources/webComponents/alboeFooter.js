...
class AlboeFooter extends HTMLElement {
  constructor() {
    ...
    fetch(window.location.href + 'internalResources/siteStructure/siteStructure.json')
      .then(r => r.json())
      .then(j => {
    ...
    fetch(window.location.href + 'internalResources/assets/github.svg')
      .then(r => r.text())
      .then(inner => {
    ...
    fetch(window.location.href + 'internalResources/assets/apple-music.svg')
      .then(r => r.text())
      .then(inner => {
